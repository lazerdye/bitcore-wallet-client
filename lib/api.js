...
API.prototype._doPublicRequest = function(method, url, args, cb) {
  var absUrl = this.baseUrl + url;
  var args = {
    // relUrl: only for testing with `supertest`
    relUrl: this.basePath + url,
...
API.prototype._doPublicPostRequest = function(url, args, cb) {
  return this._doPublicRequest('post', url, args, cb);
};
...
API.prototype._doPublicGetRequest = function(url, cb) {
  url += url.indexOf('?') > 0 ? '&' : '?';
  url += 'r=' + _.random(10000, 99999);
  return this._doPublicRequest('get', url, {}, cb);
};
...
API.prototype.createPublicAddress = function(peerId, cb) {
  this._doPublicPostRequest('/v1/addresses/' + peerId + '/', {}, function(err, address) {
...
API.prototype.getPublicAddresses = function(peerId, cb) {
  this._doPublicGetRequest('/v1/addresses/' + peerId + '/',
...
API.prototype.getPeerBalance = function(peerId, cb) {
  this._doPublicGetRequest('/v1/balance/' + peerId + '/', cb);
};
